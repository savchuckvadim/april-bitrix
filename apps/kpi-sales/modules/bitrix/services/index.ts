import { API_METHOD, onlineGeneralAPI as online, OnlineResponse } from "@workspace/api"
...
export const setupBitrixApp = async (data: BitrixAppPayload) => {
    ...
    //     }
    // }
    const result = await online.service(SETUP_ENDPOINT.CHECK, API_METHOD.POST, data) as Promise<OnlineResponse>
    return result
}