...
import { getDepartamentIds, getDepartmentByDomain, getReportInitDepartment, prepareDepartmentResponse } from '../../departament/lib/department-util';
import { BxDepartmentDtoDomain } from '@workspace/nest-api/src/generated/model/bxDepartmentDtoDomain';
import { BXUserDto, Filter, FilterInnerCode, ReportGetFiltersDto } from '@workspace/nest-api';
    ...
    () => async (dispatch: AppDispatch, getState: () => RootState) => {
        ...
        if (currentUserId) {
            ...
            if (stateDepartament.length) {
                ...
                const departamentResponse = await getDepartmentByDomain(domain as BxDepartmentDtoDomain);
