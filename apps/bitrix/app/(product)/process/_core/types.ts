...
export interface QuestionEffect {
    ...
    /** Дальше этой стадии лид не идёт, как бы ни была выкручена крутилка. */
...
export interface StageView {
    ...
    writesKpi: boolean;
    /** Лид не дошёл сюда не из-за крутилки, а из-за регламента. */
...
export interface FlowStep {
     ...
     * (лид/сделка) и исполнитель — то есть шаг сам подхватывает и крутилки,
     ...
     * приложение «Звонки» при текущих крутилках.
     */
