// 'use client';
// import { BitrixAppEntity } from "@workspace/nest-api";
// import { useBxApps } from "../../lib/bx-app.hook";

// export const PortalApps = ({ portalId }: { portalId: number }) => {
//     const { portalApps } = useBxApps(portalId);
//     return <div>
//         {portalApps?.length && portalApps.map((app: BitrixAppEntity) => (
