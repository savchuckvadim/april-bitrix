...
export interface ICurrentComplect {
    ...
    title: ComplectShortitlesEnum  //обычное отображаемое имя
    shortTitle: ComplectShortitlesEnum  //сокращенное наименование для верстки например ГЛ. Бух
...
export type ComplectWeightType = 0 | 1 | 1.5 | 2 | 2.5 | 3 | 3.5 | 4 | 6 | 7 | 8 | 9 | 12 | 12.5 | 15.5
