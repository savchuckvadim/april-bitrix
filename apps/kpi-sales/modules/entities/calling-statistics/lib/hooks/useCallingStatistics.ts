...
import { callingStatisticsApi, useGetCallingStatisticsQuery } from '../../model/callingStatisticsService'
...
export const useCallingStatistics = () => {
    ...
    const isLoading = useAppSelector(state => state.callingStatistics.isLoading)
