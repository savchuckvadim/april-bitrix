...
const INBOUND_QUESTIONNAIRE: HowQuestionnaire = {
    ...
    questions: [
        ...
        },
        {
            ...
            hint: 'Это не отдельное решение, а следствие покрытия лида и сделки: место формы вычисляется из настройки. Форма везде одна, но глубина KPI зависит от отдельного вопроса.',
            options: [
                { value: 'только из сделок', recommended: true },
                {
                    value: 'из сделок и из лидов — тогда работать придётся в двух местах',
                },
                { value: 'только из лидов' },
            ],
        },
        {
            id: 'pres-before-id',
