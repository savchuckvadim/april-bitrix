...
interface PortalMeasureCardProps {
    item: PortalMeasureResponseDto;
    onEdit?: () => void;
    onDelete?: () => void;
    onViewDetails?: () => void;
}

export function PortalMeasureCard({
    item,
    onEdit,
    onDelete,
    onViewDetails,
}: PortalMeasureCardProps) {
    return (
        <Card className="hover:shadow-md transition-shadow">
            ...
            <CardContent>
                <div className="space-y-2 text-sm">
                    ...
                    {/* TODO: Добавьте поля из PortalMeasureResponseDto */}
                </div>
            </CardContent>
