...
// Без бэка: выгрузить спеку офлайн (back/scripts/dump-openapi.ts kpi-report-sales
// out.json) и передать файл через ORVAL_INPUT=<путь к json> pnpm generate.
const baseurl =
    process.env.ORVAL_INPUT ?? `http://localhost:3001/docs/api-json`;
