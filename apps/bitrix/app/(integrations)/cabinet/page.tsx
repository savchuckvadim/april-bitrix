 ...
 * живой тест 2026-07-16). Кабинету нужен чистый контекст — весь контекст
 * портала приходит в query от бэкенд-роутера. Поэтому у /cabinet нет
 * layout с <App>, в отличие от (product)/(protected)/(auth).
 */
