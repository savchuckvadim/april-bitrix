...
// import { EOfferBlockType, IOfferTemplateBlock, IOfferBlockDocumentNumber } from '@/modules/entities/offer-template-block/type/offer-template-block.type';
...
// const BlockChooseItem: React.FC<{ block: IOfferTemplateBlock, addBlock: () => void }> = ({ block, addBlock }) => {
...
//                         <p>{(block as unknown as IOfferBlockDocumentNumber).content.appeal}</p>
//                         <p>ЗАО "Конструктор"</p>
