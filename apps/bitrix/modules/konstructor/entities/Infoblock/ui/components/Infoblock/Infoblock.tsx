...
import { AIBlock } from "@konstructor/entities/Infoblock/type/document-infoblock-type";
...
export const Infoblock: FC<IBlockProps> = ({ iblock }) => {
      ...
      <FormControl>
        <Label className="col-md-12 mb-0 d-flex align-items-center justify-content-start">
          <Input
            ...
            id="flexCheckDefault"
            className={`mb-1 me-1 ${
              iblock.checked ? "word__checkbox__active" : "word__checkbox"
            } `}
            color="primary"
            // style={{ lineHeight: 0 }}
            value={1}
