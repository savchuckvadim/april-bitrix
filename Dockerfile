...
RUN echo "base BACK_API_URL=${BACK_API_URL}"
RUN echo "base ONLINE_API_KEY=${ONLINE_API_KEY}"
RUN echo "base YANDEX_ID=${YANDEX_ID}"
RUN echo "base IN_BITRIX=${IN_BITRIX}"
RUN echo "base LOG_FILE_PATH=${LOG_FILE_PATH}"
...
ENV IN_BITRIX=false
ENV LOG_FILE_PATH='/app/logs/server.log'
RUN echo "prod BACK_API_URL=${BACK_API_URL}"
RUN echo "prod ONLINE_API_KEY=${ONLINE_API_KEY}"
RUN echo "prod YANDEX_ID=${YANDEX_ID}"
RUN echo "prod IN_BITRIX=${IN_BITRIX}"
RUN echo "prod LOG_FILE_PATH=${LOG_FILE_PATH}"
