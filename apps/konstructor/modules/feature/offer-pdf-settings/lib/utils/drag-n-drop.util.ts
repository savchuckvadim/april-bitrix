...
import { OfferPdfSetting, OfferPdfPage } from "../../model/OfferPdfSettingsSlice";
import { addNewPage, updateDifferentPages, updateIdenticalPages } from "../state-utils/page.state.util";
...
export const handleDragEnd = (
    ...
    let targetPage: OfferPdfPage | undefined;
    ...
    if (sourcePage.id === targetPage.id) {
      updateIdenticalPages(dispatch, sourcePage, activeId, insertBeforeBlockId);
    } else {
      updateDifferentPages(dispatch, sourcePage, targetPage, activeId, insertBeforeBlockId);
    }
  };
