...
import { EReportDateMode, ReportDateType } from '@/modules/entities/report/model/types/report/report-type';
                ...
                >
                    ...
                    <div className="flex items-center space-x-2">
                        <RadioGroupItem
                            ...
                            onClick={() =>
                                handleQuickSelect(EReportDateMode.TODAY)
                            }
                        />
                    ...
                    <div className="flex items-center space-x-2">
                        <RadioGroupItem
                            ...
                            onClick={() =>
                                handleQuickSelect(EReportDateMode.WEEK)
                            }
                        />
                    ...
                    <div className="flex items-center space-x-2">
                        <RadioGroupItem
                            ...
                            onClick={() =>
                                handleQuickSelect(EReportDateMode.MONTH)
                            }
                        />
