...
const testimonials = [
    {
        ...
        text: 'Внедрение заняло всего 3 недели вместо обещанных конкурентами 3 месяцев. Менеджеры быстро освоили систему, а аналитика KPI помогла увеличить продажи на 30%.',
        result: 'Продажи +30%',
    },
    {
        name: 'Мария Сидорова',
        position: 'Коммерческий директор',
        company: 'ООО "Компания Б"',
        ...
        result: 'Время реакции -50%',
    },
    {
        name: 'Алексей Иванов',
        position: 'Руководитель отдела сервиса',
        company: 'ООО "Компания В"',
