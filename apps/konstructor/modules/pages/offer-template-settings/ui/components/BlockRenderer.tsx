...
// export const BlockRenderer: React.FC<{ block: IOfferTemplateBlock }> = ({ block }) => {
...
//         <BlockWrapper>
//           <OfferHero
//             block={isSelected ? editeble : block}
...
//     case 'documentNumber':
//       return <div className={`flex flex-row justify-between text-xs mt-10  p-2`}
//         style={{
