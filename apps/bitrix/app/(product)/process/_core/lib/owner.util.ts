/**
 * Кодирование владельца стадии — какая сущность её держит при текущих ползунках.
...
export const OWNER_NOTE: Record<StageOwner, string> = {
    lead: 'При текущих настройках человек работает здесь в карточке лида.',
    deal: 'При текущих настройках человек работает здесь в сделке.',
