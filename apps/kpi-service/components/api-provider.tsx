...
// Бэкенд event-service — портальная поверхность СКАП (@workspace/skap в
// шапке отчёта). NEXT_PUBLIC_* инлайнится в бандл на билде, поэтому работает
// и на клиенте. Без переменной остаётся dev-дефолт пакета (localhost:3006).
