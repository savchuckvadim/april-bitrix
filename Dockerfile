...
RUN echo "BACK_API_URL=${BACK_API_URL}"
RUN echo "ONLINE_API_KEY=${ONLINE_API_KEY}"
RUN echo "YANDEX_ID=${YANDEX_ID}"
RUN echo "IN_BITRIX=${IN_BITRIX}"
RUN echo "LOG_FILE_PATH=${LOG_FILE_PATH}"
