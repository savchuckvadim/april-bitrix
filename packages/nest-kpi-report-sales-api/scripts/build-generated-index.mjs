...
// Раньше он был ручным и терялся при удалении/регенерации папки generated.
// Этот скрипт вызывается ПОСЛЕ orval (см. npm-скрипт `generate`) и полностью
// восстанавливает barrel из фактических тег-папок — руками писать не нужно.
