...
export const getAuth = () => {
     ...
     */
    const authValidateResetPasswordToken = (token: string) => {
        return customAxios<ResetPasswordTokenStatusDto>({
            url: `/api/auth/reset-password/validate/${token}`,
            method: 'GET',
        });
    };
    /**
...
>;
export type AuthValidateResetPasswordTokenResult = NonNullable<
    Awaited<
        ReturnType<ReturnType<typeof getAuth>['authValidateResetPasswordToken']>
    >
>;
