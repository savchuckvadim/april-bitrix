...
import { useSmartFields } from '../lib/hooks/use-smart-fields';
...
export function SmartFieldsManager({ context }: { context: EntityFieldsContext }) {
    const {
        fields,
        isLoading,
        createField,
    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center justify-between">
                <h2 className="text-xl font-semibold">Связанные Bitrix Fields (Smart)</h2>
                <div className="flex gap-2">
