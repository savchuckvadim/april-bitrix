...
interface BitrixFieldCardProps {
    item: BitrixFieldResponseDto;
    onEdit?: () => void;
    onDelete?: () => void;
    onViewDetails?: () => void;
}

export function BitrixFieldCard({
    item,
    onEdit,
    onDelete,
    onViewDetails,
}: BitrixFieldCardProps) {
    return (
        <Card className="hover:shadow-md transition-shadow">
            ...
            <CardContent>
                <div className="space-y-2 text-sm">
                    ...
                    {/* TODO: Добавьте поля из BitrixFieldResponseDto */}
                </div>
            </CardContent>
