...
export default function EditBitrixFieldPage({
    ...
    const handleSubmit = (data: PbxUpdateFieldDto) => {
    ...
    return (
        <div className="container mx-auto py-8 max-w-2xl">
            <BitrixFieldForm
                mode="edit"
                initialData={bitrixFields as PbxUpdateFieldDto}
                onSubmit={(data: PbxCreateFieldsBulkDto | PbxUpdateFieldDto) => handleSubmit(data as PbxUpdateFieldDto)}
