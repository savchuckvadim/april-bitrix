...
export interface SimEventType {
     ...
     * ровно шесть типов — звонок, презентация, доработка, решение, оплата и
     * поставка. Холодного звонка среди них нет намеренно: холодная задача
     * приходит только извне — её ставит хук ХО. Планировать можно «от обычного
