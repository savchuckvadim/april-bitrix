...
export const CreateShareLinkDialog = () => {
    ...
    return (
        ...
        >
            ...
            >
                Использовано {usedCount} из {SHARE_LINK_MAX_ACTIVE} активных
                ссылок
                {limitReached &&
            ...
            {createdToken ? (
                <>
                    <div className="space-y-2 rounded-md bg-emerald-500/10 px-3 py-2.5">
                        ...
                        <ShareLinkUrlField url={buildShareUrl(createdToken)} />
                        <div className="text-[11px] text-muted-foreground">
                            Кликните по полю — ссылка выделится целиком,
                            скопируйте её (Ctrl+C) или откройте по стрелке в
                            новой вкладке.
                        </div>
                    </div>
