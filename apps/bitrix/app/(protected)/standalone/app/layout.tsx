...
export default function BitrixCabinetPage() {
    ...
    return (
        <div className="min-h-screen py-2 px-10 mx-auto bg-gray-50">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-8">
                            ...
                            <div className="hidden md:flex items-center gap-6">
                                <Link href="/standalone/bitrix" className="text-blue-600 font-medium border-b-2 border-blue-600 pb-1">
                                    Кабинет
                                </Link>
                                <Link href="/standalone/bitrix/placement/list" className="text-gray-600 hover:text-gray-900 font-medium">
                                    Виджеты
                                </Link>
                                <Link href="/standalone/bitrix/secret" className="text-gray-600 hover:text-gray-900 font-medium">
                                    Настройки
                                </Link>
                            </div>
                        </div>
