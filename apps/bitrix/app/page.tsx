                        ...
                        <Card className="hover:shadow-xl transition-all duration-300 cursor-pointer group border-2 hover:border-green-200">
                            <CardHeader>
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex-1">
                                        <CardTitle className="text-xl">Для клиентов</CardTitle>
                                        <CardDescription>Регистрация и настройка портала</CardDescription>
                                    </div>
                                    <ArrowRight className="w-5 h-5 text-gray-400 group-hover:text-green-600 transition-colors" />
                                </div>
                            </CardHeader>
                            <CardContent>
                                <div className="space-y-3">
                                    ...
                                    <div className="flex items-center gap-2 text-sm text-gray-600">
                                        <CheckCircle className="w-4 h-4 text-green-500" />
                                        <span>Настройка портала</span>
                                    </div>
                                    <div className="flex items-center gap-2 text-sm text-gray-600">
                                        <CheckCircle className="w-4 h-4 text-green-500" />
                                        <span>OAuth приложение</span>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
