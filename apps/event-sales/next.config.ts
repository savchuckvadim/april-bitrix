...
const nextConfig: NextConfig = {
    ...
    transpilePackages: ['@workspace/api', '@workspace/ui', '@workspace/april-ui', '@workspace/bitrix', '@workspace/bx', '@workspace/pbx', '@workspace/pbx-data', '@workspace/nest-api', '@workspace/nest-event-sales-api', '@workspace/event-sales-flow'],
};
