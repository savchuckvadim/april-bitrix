...
const OVERVIEW_FLOW: LeadsFlowDef = {
    id: 'overview',
    title: 'Обзор: четыре фазы процесса',
    height: 320,
    caption:
        'Где стоит форма «Звонки» — следствие настройки, а не константа: при рекомендованной схеме «Админ + Сделка» менеджер в лид не заходит вовсе, лид разбирает администратор. Остальные фазы — автоматика. Пунктир — путь мусора: закрытие без следов в учёте.',
    nodes: [
        {
            id: 'start',
            kind: 'event',
            position: { x: 0, y: 90 },
            data: { label: 'Лид создан', tone: 'start', horizontal: true },
        },
        {
            id: 'f1',
            kind: 'task',
        ...
        },
        {
            ...
            position: { x: 690, y: 80 },
            data: {
                label: 'Фаза 3 · Опознание',
                sub: 'менеджер + руководитель',
                actor: 'mgr',
                horizontal: true,
            },
        },
        ...
        },
        {
            ...
            data: { label: 'lead_junk', tone: 'junk', horizontal: true },
        },
    ],
    edges: [
...
const MAIN_FLOW: LeadsFlowDef = {
    id: 'main',
    title: 'Полный BPMN-процесс профиля A',
    height: 980,
    caption:
    ...
    nodes: [
        {
            ...
            kind: 'event',
            position: { x: 470, y: 0 },
            data: { label: 'Лид создан', tone: 'start' },
        },
        {
            id: 'cls',
            kind: 'gateway',
            position: { x: 460, y: 110 },
            data: { label: 'Класс лида?' },
        },
        {
            id: 'junk1',
            kind: 'event',
            position: { x: 850, y: 115 },
            data: { label: 'lead_junk', tone: 'junk' },
        },
        {
            id: 'quar',
            kind: 'task',
            position: { x: 60, y: 110 },
            data: {
                label: 'Карантин импорта',
                sub: 'выпуск порциями — решает РОП',
                actor: 'rop',
                tone: 'warn',
            },
        },
        {
            ...
            data: {
                label: 'Проверка на дубли',
                sub: 'телефон + email + ИНН, по лидам, контактам, компаниям',
                actor: 'sys',
            },
        },
        {
        ...
        },
        {
            ...
            data: {
                ...
                sub: 'менеджер выясняет название и ИНН',
                actor: 'mgr',
            },
        },
        {
            ...
            data: {
                label: 'Похоже, знакомая',
                sub: 'карточка совпадения в ленте лида',
                actor: 'mgr',
            },
        },
        {
        ...
        },
        {
            ...
            data: {
                label: 'Звонок из карточки лида',
                sub: 'вкладка «Звонки», та же форма · событие KPI',
                actor: 'mgr',
            },
        },
        {
            ...
            data: { label: 'Компания опознана?' },
        },
        {
            id: 'junk2',
            kind: 'event',
            position: { x: 700, y: 705 },
            data: { label: 'lead_junk', tone: 'junk' },
        },
        {
            id: 'bind',
            ...
            position: { x: 60, y: 810 },
            data: {
                label: 'Привязка к существующей',
                sub: 'дубли — только ручное слияние',
                actor: 'sys',
            },
        },
        {
            id: 'create',
            kind: 'task',
            position: { x: 420, y: 810 },
            data: { label: 'Создание компании из лида', actor: 'sys' },
        },
        {
            id: 'live',
            kind: 'gateway',
            position: { x: 120, y: 905 },
            data: { label: 'Есть живая сделка?' },
        },
        {
            id: 'conv',
            kind: 'task',
            position: { x: 420, y: 905 },
            data: {
                label: 'Конвертация',
                sub: 'лид → CONVERTED · сделка «Новая» → скрипт двигает по источнику',
                actor: 'sys',
            },
        },
        {
            ...
            data: {
                label: 'Заявка — к сделке',
                sub: 'лишняя сделка → «Дубль» · уведомить ответственного',
                actor: 'sys',
            },
        },
        {
            id: 'done',
            kind: 'event',
            position: { x: 480, y: 1035 },
            data: { label: 'Контур компания + сделка', tone: 'done' },
        },
    ],
    edges: [
        ...
        { source: 'call', target: 'id' },
        {
            source: 'id',
            target: 'call',
            label: 'контакт целевой — следующий звонок',
        },
...
const DEDUP_FLOW: LeadsFlowDef = {
    id: 'dedup',
    title: 'Конвейер проверки на дубли',
    height: 420,
    caption:
    ...
    nodes: [
        ...
        },
        {
            ...
            position: { x: 0, y: 220 },
            data: {
                label: 'Кнопка в «Звонках»',
                sub: 'менеджер узнал ИНН',
                actor: 'mgr',
                horizontal: true,
            },
        },
        ...
        },
        {
            ...
            data: {
                label: 'Нормализация',
                sub: 'телефоны к единому формату, email к нижнему регистру',
                actor: 'sys',
                horizontal: true,
            },
        },
        {
            ...
            data: {
                ...
                sub: 'по лидам, контактам, компаниям',
                actor: 'sys',
                horizontal: true,
            },
        },
        ...
        },
        {
            id: 'enrich',
            kind: 'task',
            position: { x: 1370, y: 110 },
            data: {
                label: 'Обогащение',
                sub: 'открытые сделки · ответственные',
                actor: 'sys',
                horizontal: true,
            },
        },
        {
            id: 'res',
            kind: 'task',
            position: { x: 1640, y: 110 },
            data: {
                label: 'Карточка результата',
                sub: 'лента лида + кнопки «Это она» / «Не она» / «Эскалировать»',
                actor: 'sys',
                horizontal: true,
            },
        },
