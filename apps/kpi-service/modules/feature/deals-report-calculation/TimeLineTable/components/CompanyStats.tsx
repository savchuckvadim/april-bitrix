...
/**
 * Статистика компании в строке таймлайна.
 *
 * React.memo: stats — стабильный объект из useMemo родителя, компонент
 * не должен ре-рендериться при разворачивании чужих строк/скролле.
 * Явные TooltipProvider убраны — shadcn-обёртка Tooltip уже включает
 * провайдер, а лишний удваивал число инстансов на каждую строку.
 */
export const CompanyStatsComponent: React.FC<CompanyStatsProps> = React.memo(
    ({ stats, showIndex = true }) => {
        return (
                ...
                {showIndex && (
                    <div className="flex flex-col items-center min-w-[80px]">
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <Badge
                                    className={`text-xs ${getIndexColor(stats.indexGrowth)} cursor-help`}
                                >
                            ...
                            <TooltipContent className="max-w-xs">
                                <div className="space-y-2">
                                    ...
                                    <div className="text-xs text-gray-500 pt-1 border-t">
                                        Положительное значение = рост платежей
                                        <br />
...
CompanyStatsComponent.displayName = 'CompanyStatsComponent';
