        ...
        return (
            <div className="border-warning/40 bg-warning/5 rounded-lg border p-3">
                ...
                <p className="text-muted-foreground mt-1 text-[11px] leading-relaxed">
                    Отчёт нерезультативный — значит встречи не было. Сделка в
                    воронке «ОП Презентации» закроется на стадии «Не
                    состоялась», а новую встречу заводят новой сделкой.
                </p>
            </div>
        );
    }
        ...
        <div>
            ...
            <p className="text-muted-foreground mt-1.5 text-[11px] leading-relaxed">
                {held
                    ...
                    : 'Разговор был результативным, но встреча не состоялась: в отчёты уйдёт звонок, а сделка-спутник закроется на «Не состоялась».'}
            </p>
        </div>
    );
};
