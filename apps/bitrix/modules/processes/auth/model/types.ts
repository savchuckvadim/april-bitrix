import { ClientDto, ClientRegistrationRequestDto, LoginDto, UserResponseDto } from "@workspace/nest-api";


export interface IRegisterForm extends ClientRegistrationRequestDto {
    domain: string;
    name: string;
    email: string;
    password: string;
