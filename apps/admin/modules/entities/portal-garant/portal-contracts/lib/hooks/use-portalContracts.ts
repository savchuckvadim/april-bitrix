...
export const usePortalContracts = (params?: PortalContractGetListPortalContractsParams) => {
    return useQuery<PortalContractResponseDto[], Error>({
        ...
        queryFn: async () => {
            const response = await portalContractHelper.getPortalContracts(
                params || ({} as Partial<PortalContractGetListPortalContractsParams>) as PortalContractGetListPortalContractsParams,
            );
            return response;
        },
        enabled: !!params,
