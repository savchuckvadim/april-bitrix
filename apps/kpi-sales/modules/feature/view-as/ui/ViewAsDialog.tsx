...
export const ViewAsDialog = ({ open, onOpenChange }: ViewAsDialogProps) => {
    ...
    return (
        <GlassDialog
            ...
            size="xs"
            cardClassName="max-h-[75vh] gap-3 overflow-hidden"
        >
            <DialogHeader>
                <DialogTitle>Смотреть как…</DialogTitle>
            </DialogHeader>
            <p className="text-xs text-muted-foreground">
                Отчёт откроется глазами выбранного сотрудника: его периметр, его
                сохранённый фильтр. Его настройки при этом не изменятся —
                сохранение в этом режиме отключено.
            </p>
            <Input
                value={query}
