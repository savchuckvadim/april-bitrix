...
const callingStatisticsSlice = createSlice({
  ...
  reducers: {
    ...
    setLoading: (state: CallingStatisticsState, action: PayloadAction<boolean>) => {
      state.isLoading = action.payload;
    },
    setFetched: (state: CallingStatisticsState, action: PayloadAction<ReportCallingData[] | null>) => {
