...
const offerWordPdfPreviewStopPreview = (
  ...
  return {offerWordGenerateGenerateOfferWord,offerWordPdfPreviewStartPreview,offerWordPdfPreviewGetPreviewStatus,offerWordPdfPreviewStopPreview,offerCreateOffer}};
