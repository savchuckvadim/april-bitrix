...
interface BtxCategorieCardProps {
    item: BtxCategoryResponseDto;
    onEdit?: () => void;
    onDelete?: () => void;
    onViewDetails?: () => void;
}

export function BtxCategorieCard({
    item,
    onEdit,
    onDelete,
    onViewDetails,
}: BtxCategorieCardProps) {
    return (
        <Card className="hover:shadow-md transition-shadow">
            ...
            <CardContent>
                <div className="space-y-2 text-sm">
                    ...
                    {/* TODO: Добавьте поля из BtxCategoryResponseDto */}
                </div>
            </CardContent>
