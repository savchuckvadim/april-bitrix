...
import { OrkUserReportStartResponseDto } from "@workspace/nest-api";
...
const userReportSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder.addCase(getUserReportThunk.fulfilled, (state: IUserReportState, action: PayloadAction<OrkUserReportStartResponseDto | null>) => {
            if (!action.payload) {
                return;
            }
